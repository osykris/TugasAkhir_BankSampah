            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="font-weight-normal" style="color: #071C4D;">Lupa <span class="font-weight-bold">Password</span> Anda?</h4>
                        <p class="text-muted">Tidak masalah. Cukup beri tahu kami alamat email Anda dan kami akan mengirim email kepada Anda tautan pengaturan ulang kata sandi yang memungkinkan Anda memilih yang baru.</p>
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="form-group">
                                <x-button style="background-color:#FF9E53; color:white;" class="btn btn-lg btn-icon icon-right">
                                    {{ __('Reset Password') }}
                                </x-button>
                            </div>
                        </form>
