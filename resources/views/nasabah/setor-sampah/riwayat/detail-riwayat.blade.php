...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="{{ route('riwayat-transaksi') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Detail Setor</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="{{ route('riwayat-transaksi') }}">Riwayat Transaksi</a></div>
